...
namespace LibClang
{
    public class TokenCollection :ClangObject<IntPtr> ,IReadOnlyList<Token>
    {
        internal unsafe TokenCollection(TranslationUnit translationUnit, CXToken* pTokens, uint tokensCount)
        {
